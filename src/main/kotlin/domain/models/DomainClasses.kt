...
data class Country (val cioc: String, val nameEN: String, val nameES: String, val nameEU: String, val capital: String, val region: String, val subregion: String, var url: String)
